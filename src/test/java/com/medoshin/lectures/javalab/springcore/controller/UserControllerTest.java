...
public class UserControllerTest {
    ...
    public void initIt() throws SQLException {
        mockMvc = MockMvcBuilders
                .standaloneSetup(new UserController(userDao), new TestController())
                .build();
    }
...
////        when(mockUserDao.getUserById(anyInt())).thenReturn(userStub);
//        List<String> list = Arrays.asList("as;dlfj", "asdf");
